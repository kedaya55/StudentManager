	...
	<div id="addDialog" style="padding: 10px;">
		<form id="photoForm" method="post" enctype="multipart/form-data" action="upload_photo" target="photo_target">
			<table id="addTable1" cellpadding="8">
				<tr >
					<td>预览头像:</td>
					<td>
						<img id="photo-preview" alt="照片" style="max-width: 100px; max-height: 100px;" title="照片" src="${pageContext.request.contextPath}/photo/student.jpg" />
					</td>
				</tr>
				<tr >
					<td>学生头像:</td>
		...
		<form id="addForm" method="post">
			<table id="addTable2" cellpadding="8">
				<input id="add_photo" type="hidden" name="photo" value="${pageContext.request.contextPath}/photo/student.jpg"  />
				<tr >
					<td>学生姓名:</td>
					<td>
