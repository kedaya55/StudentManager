    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
             <c:if test="${userType == 1}">
						...
						{"menuid":"3","icon":"","menuname":"年纪信息管理",
							"menus":[
									{"menuid":"31","menuname":"年纪列表","icon":"icon-world","url":"../grade/list"},
								]
						},
...
<body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="padding-left:10px; font-size: 16px; ">kedaya学生信息管理系统</span>
    </div>
    <div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
        <div class="footer">Copyright &copy; kedaya By huangtao</div>
    </div>
